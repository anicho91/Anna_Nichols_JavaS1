...
public class AllKatasTest {
      ...
      public void testInheritance() {
          ...
          String failMessage = "Expected Accord to inherit from Car and Sedan";
          assertTrue(failMessage, accord instanceof com.company.interfaces.Vehicle);
      ...
      public void testComposition() throws Exception {
          ...
          String failMessage = "Expected getEngine to return an Engine class";
          assertTrue(failMessage, accord.getEngine() instanceof Engine);

          failMessage = "Expected getTransmission to return an Engine class";
      ...
      public void testMethods() throws Exception {
          ...
          String failMessage = "Expected Accord to have drive method which takes an integer parameter";
          assertNotNull(failMessage, acc.getMethod("drive", int.class));
          failMessage = "Expected Accord to have displayMilesTraveled method";
