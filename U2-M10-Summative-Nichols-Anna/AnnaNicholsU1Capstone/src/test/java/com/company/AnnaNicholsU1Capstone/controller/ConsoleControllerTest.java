...
public class ConsoleControllerTest {
    ...
    public void createConsoleTestWithAdmin() throws Exception {
    ...
    @Test
    @WithMockManager
    public void createConsoleTestWithManager() throws Exception {
        ConsoleViewModel cvm = new ConsoleViewModel();
        cvm.setModel("Playstation");
        cvm.setManufacturer("Sony");
        cvm.setMemoryAmount("2TB");
    ...
    @Test
    @WithMockStaffMember
    public void createConsoleTestWithStaffMemberForbidden() throws Exception {
        ConsoleViewModel cvm = new ConsoleViewModel();
        cvm.setModel("Playstation");
        cvm.setManufacturer("Sony");
        cvm.setMemoryAmount("2TB");
    ...
    @Test
    @WithMockNewUser
    public void createConsoleTestWithForbidden() throws Exception {
        ConsoleViewModel cvm = new ConsoleViewModel();
        cvm.setModel("Playstation");
        cvm.setManufacturer("Sony");
        cvm.setMemoryAmount("2TB");
    ...
    @Test
    @WithAnonymousUser
    public void createConsoleTestWithAnonUnauthorized() throws Exception {
        ConsoleViewModel cvm = new ConsoleViewModel();
        cvm.setModel("Playstation");
        cvm.setManufacturer("Sony");
        cvm.setMemoryAmount("2TB");
    ...
    public void getAllConsolesTest() throws Exception {
        ...
        String outputJson = mapper.writeValueAsString(cvmList);
    ...
    @Test
    @WithAnonymousUser
    public void updateConsoleTestWithAnonIsUnauthorized() throws Exception {
        ConsoleViewModel cvm2 = new ConsoleViewModel();
        cvm2.setModel("Xbox");
        cvm2.setManufacturer("Microsoft");
        cvm2.setMemoryAmount("2TB");
    ...
    @Test
    @WithMockNewUser
    public void updateConsoleTestWithAnonIsForbidden() throws Exception {
        ConsoleViewModel cvm2 = new ConsoleViewModel();
        cvm2.setModel("Xbox");
        cvm2.setManufacturer("Microsoft");
        cvm2.setMemoryAmount("2TB");
    ...
    @Test
    @WithMockStaffMember
    public void updateConsoleTestWithStaffMember() throws Exception {
        ConsoleViewModel cvm2 = new ConsoleViewModel();
        cvm2.setModel("Xbox");
        cvm2.setManufacturer("Microsoft");
        cvm2.setMemoryAmount("2TB");
    ...
    @Test
    @WithMockManager
    public void updateConsoleTestWithManager() throws Exception {
        ConsoleViewModel cvm2 = new ConsoleViewModel();
        cvm2.setModel("Xbox");
        cvm2.setManufacturer("Microsoft");
        cvm2.setMemoryAmount("2TB");
    ...
    @Test
    @WithMockAdmin
    public void updateConsoleTestWithAdmin() throws Exception {
        ConsoleViewModel cvm2 = new ConsoleViewModel();
        cvm2.setModel("Xbox");
        cvm2.setManufacturer("Microsoft");
        cvm2.setMemoryAmount("2TB");
    ...
    @Test
    @WithAnonymousUser
    public void deleteConsoleTestWithAnonUnauthorized() throws Exception {

        this.mockMvc.perform(delete("/console/2")
                .with(csrf().asHeader()))
    ...
    @Test
    @WithMockNewUser
    public void deleteConsoleTestWithUserForbidden() throws Exception {
    ...
    @Test
    @WithMockStaffMember
    public void deleteConsoleTestWithStaffMemberForbidden() throws Exception {
    ...
    @Test
    @WithMockManager
    public void deleteConsoleTestWithManagerForbidden() throws Exception {
    ...
    @Test
    @WithMockAdmin
    public void deleteConsoleTestWithAdmin() throws Exception {
    ...
    @Test
    @WithMockAdmin
    public void test400ErrorWhenPostingConsole() throws Exception{
        ConsoleViewModel cvm = new ConsoleViewModel();
    ...
    @Test
    public void testing404ErrorWhenGettingConsole() throws Exception{
        ConsoleViewModel cvm = new ConsoleViewModel();
    ...
    @Test
    @WithMockAdmin
    public void testing405ErrorWhenPostingConsole() throws Exception{
    ...
    @Test
    @WithMockAdmin
    public void testing415ErrorWhenUpdatingConsole() throws Exception{
    ...
    @Test
    public void test422ErrorWhenGettingConsole() throws Exception{
        ConsoleViewModel cvm = new ConsoleViewModel();

        String id422Console = "z";

        this.mockMvc.perform(get("/console/" + id422Console))
                .andDo(print())
