...
public class AlbumDaoJdbcTemplateImpl implements AlbumDao {
    ...
    private static final String UPDATE_ALBUM_SQL =
            "update album set title=?, artist_id=?, release_date=?, label_id=?, list_price=?, album_id=?";
    ...
    @Autowired
    public AlbumDaoJdbcTemplateImpl(JdbcTemplate jdbcTemplate) {this.jdbcTemplate = jdbcTemplate;}
