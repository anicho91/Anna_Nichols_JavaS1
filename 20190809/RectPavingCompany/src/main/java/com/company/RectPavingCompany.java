...
public class RectPavingCompany {
    ...
    public static void main(String[] args) {
        ...
        //added \n to all questions so the input went to the next line instead of the end of the question
        ...
        //Used cement cost variable instead of framing cost variable.
        System.out.print("What is the cost of framing/footers per linear foot? \n");
        framingCost = Float.parseFloat(scan.nextLine());

        int area = length * width;

        //had 2*l - 2*w when the correct perimeter formula is 2*l + 2*w
        ...
        //had perimeter+framingCost when it needs to be perimeter*framingCost to find the
